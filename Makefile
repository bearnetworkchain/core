...
LD_FLAGS = -X github.com/bearnetworkchain/core/ignite/version.Head='$(HEAD)' \
	-X github.com/bearnetworkchain/core/ignite/version.Date='$(DATE)'
...
format:
	...
	@find . $(FIND_ARGS) | xargs goimports -w -local github.com/bearnetworkchain/core
