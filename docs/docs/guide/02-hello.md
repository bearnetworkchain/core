...
In the previous chapter you've learned how to install [Ignite CLI](https://github.com/bearnetworkchain/core), the tool that offers everything you need to build, test, and launch your blockchain with a decentralized worldwide community.
