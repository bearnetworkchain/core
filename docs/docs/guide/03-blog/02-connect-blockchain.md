...
require (
	...
	github.com/bearnetworkchain/core v0.19.2 
)
...
[cosmosclient](https://pkg.go.dev/github.com/bearnetworkchain/core/ignite/pkg/cosmosclient) package documentation. Details are provided to learn how to use the `Client` type with `Options` and `KeyringBackend`.
