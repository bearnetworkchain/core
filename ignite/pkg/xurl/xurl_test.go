...
func TestTCP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "tcp://github.com/bearnetworkchain/core",
			want: "tcp://github.com/bearnetworkchain/core",
		},
		{
			name: "without scheme",
			addr: "github.com/bearnetworkchain/core",
			want: "tcp://github.com/bearnetworkchain/core",
		},
		{
			name: "with invalid scheme",
			addr: "ftp://github.com/bearnetworkchain/core",
			want: "tcp://github.com/bearnetworkchain/core",
		},
		{
...
func TestHTTP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "http://github.com/bearnetworkchain/core",
			want: "http://github.com/bearnetworkchain/core",
		},
		{
			name: "without scheme",
			addr: "github.com/bearnetworkchain/core",
...
func TestHTTPS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "https://github.com/bearnetworkchain/core",
			want: "https://github.com/bearnetworkchain/core",
		},
		{
			name: "without scheme",
			addr: "github.com/bearnetworkchain/core",
...
func TestWS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "ws://github.com/bearnetworkchain/core",
			want: "ws://github.com/bearnetworkchain/core",
		},
		{
			name: "without scheme",
			addr: "github.com/bearnetworkchain/core",
