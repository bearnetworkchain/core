...
// CampaignClient是 QueryClient 類型的自動生成的模擬類型
type CampaignClient struct {
	mock.Mock
}

// AuctionsOfCampaign 提供具有給定字段的模擬函數：ctx、in、opts
...
// Campaign 提供具有給定字段的模擬函數：ctx、in、opts
...
// CampaignAll 提供具有給定字段的模擬函數：ctx、in、opts
...
// CampaignChains 提供具有給定字段的模擬函數：ctx、in、opts
...
// CampaignSummaries 提供具有給定字段的模擬函數：ctx、in、opts
...
// CampaignSummary 提供具有給定字段的模擬函數：ctx、in、opts
...
// MainnetAccount 提供具有給定字段的模擬函數：ctx、in、opts
...
// MainnetAccountAll 提供具有給定字段的模擬函數：ctx、in、opts
...
// MainnetAccountBalance提供具有給定字段的模擬函數：ctx、in、opts
...
// MainnetAccountBalanceAll 提供具有給定字段的模擬函數：ctx、in、opts
...
// MainnetVestingAccount 提供具有給定字段的模擬函數：ctx、in、opts
...
// MainnetVestingAccountAll 提供具有給定字段的模擬函數：ctx、in、opts
...
// SpecialAllocationsBalance 提供具有給定字段的模擬函數：ctx、in、opts
...
// TotalShares 提供具有給定字段的模擬函數：ctx、in、opts
...
// NewCampaignClient 創建一個新的 CampaignClient 實例。它還在模擬上註冊了一個測試接口和一個清理函數來斷言模擬期望。
