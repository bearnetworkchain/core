...
// Account 提供具有給定字段的模擬函數：accountName
...
// Address 提供了一個具有給定字段的模擬函數：accountName
...
// BroadcastTx 提供具有給定字段的模擬函數：accountName、msgs
...
// BroadcastTxWithProvision 提供具有給定字段的模擬函數：accountName、msgs
...
// ConsensusInfo 提供具有給定字段的模擬函數：ctx、height
...
// NewCosmosClient 創建 CosmosClient 的新實例。它還在模擬上註冊了 testing.TB 接口和一個清理函數來斷言模擬期望。
